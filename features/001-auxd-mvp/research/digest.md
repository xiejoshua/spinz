...
- **Pricing exists in the spec as future-state, not launch-state.** auxd Pro $19/yr + Patron $39/yr in the spec but launch is free-only until WAL ≥ 1,000 and D30 ≥ 10%.
