...
Once auxd has live users, ALL schema changes follow the Constitution Principle 2 pattern:
...
```python
# apps/api/src/auxd_api/modules/auth/models.py
class User(Document):
