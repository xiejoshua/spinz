"""
auxd MVP — Migration 001_initial (forward)
...
async def main() -> int:
    parser = argparse.ArgumentParser(description="auxd MVP — initial schema migration")
    ...
    print(f"auxd MVP migration {MIGRATION_VERSION} — {'DRY RUN' if args.dry_run else 'APPLYING'}")
