...
- **Unmitigated: differentiation thinness.** Multiple prior attempts (AOTY, Albums.fm, MusicBoard) exist — Phase 1 must identify *why* they stalled to define auxd's moat.
...
- auxd competes with passive defaults (Spotify-only) as much as with active trackers — research framing should reflect "switching cost from doing nothing" not just "switching cost from existing tools."
