# Product Spec: Spinz (Social Album Platform — MVP)

> Status: DRAFT | Version: 1.0 | Date: 2026-05-21
> Feature: `001-spinz-mvp` | Size: Large
>
...
Spinz is the *unhad combination* of four things none of the 13 prior attempts (RateYourMusic, AOTY, MusicBoard, Albums.fm, hi-fi.cafe, Sonemic, Last.fm, etc.) combined:
...
- **Age:** 31
- **Context:** Music journalist, label A&R, popular-Twitter music account, niche-podcast host. Spinz needs them as the *seed graph* for Casey and Maya.
...
- **Acceptance signal:** Jamie writes a review on Spinz that ≥10 followers see organically within 24h. Spinz's seeding strategy (see [seeding-strategy.md](./seeding-strategy.md)) is built around recruiting Jamies.
...
**Definition of MVP success:** At M6, the M6 targets are met *and* qualitative interviews with 15+ active users confirm H1 (the "remember/share moment" hypothesis was real for them and Spinz captured it).
