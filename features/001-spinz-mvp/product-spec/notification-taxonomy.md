# Notification Taxonomy: Spinz MVP
...
| N-015 | `system.announcement` | Founder-issued product announcement | ❌ OFF | ❌ OFF | ❌ OFF | Opt-in to "Spinz news" in onboarding. Use sparingly (target: ≤6/year). |
...
- Subject line: actionable, not engagement-bait. ✅ `"3 friends logged albums this week"` ❌ `"You haven't been to Spinz in a while 😢"`
