...
// Minimal headless Switch — pure Tailwind, no Radix dep. Mirrors the
// shadcn API surface (controlled `checked`, `onCheckedChange`, `disabled`)
// so when we add @radix-ui/react-switch later this file can be swapped
